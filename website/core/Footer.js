    ...
    return (
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            <h5>คู่มือ</h5>
            <a href={this.docUrl("doc1.html")}>โรงเรียน/สถานศึกษา</a>
            <a href={this.docUrl("doc2.html")}>ครูอาจารย์/บุคลากร</a>
            <a href={this.docUrl("doc3.html")}>ผู้ปกครอง/นักเรียน</a>
          </div>
          <div>
            <h5>คุณสมบัติ</h5>
        ...
        <section className="copyright">
          Copyright &copy; {currentYear} Nextgensoft Co., Ltd.
        </section>
      </footer>
    );
  }
